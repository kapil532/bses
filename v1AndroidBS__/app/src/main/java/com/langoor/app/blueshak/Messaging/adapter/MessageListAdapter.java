    ...
    public void onBindViewHolder(RecyclerView.ViewHolder view_holder, final int position) {
        ...
        if(view_holder instanceof SenderHolder){
            ...
            if(!TextUtils.isEmpty(chat_user_image)&&chat_user_image!=null){
                ...
                senderHolder.profilePic.setImageResource(R.drawable.placeholder_background);
            }
            ...
            if(!TextUtils.isEmpty(image)){
                ...
                receiverHolder.profilePic.setImageResource(R.drawable.placeholder_background);
            }
            ...
            if(!TextUtils.isEmpty(message_body)){
                Picasso.with(context)
                        .load(message_body)
                        .placeholder(R.drawable.placeholder_background)
                        .fit().centerCrop()
            ...
            if(!TextUtils.isEmpty(product_image)&&product_image!=null){
                Picasso.with(context)
                        .load(product_image)
                        .placeholder(R.drawable.placeholder_background)
                        .fit().centerCrop()
                        .into(senderHolder.product_image);
            }else{
                senderHolder.product_image.setImageResource(R.drawable.placeholder_background);
            }
