...
public class ReviewsRatings extends AppCompatActivity {
    ...
    static final String  REVIEWS_RATINGS_PRODUVT_MODEL_LIST_ID = "ReviewsRatingsModelWithDetails";
    static final String  REVIEWS_RATINGS_BUNDLE_KEY_FLAG = "ReviewsRatingsFlag";
    private TextView seller_name,review,retail_price_quote, productDescriptionDetail_tv;
    ...
    private String flag = GlobalVariables.TYPE_GARAGE;
    ...
    private CardView write_review_content;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
     ...
     /*   getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        write_review_content=(CardView)findViewById(R.id.write_review_content);
       ...
       /* relatedList=reviewsRatingsModel.getReviews_list();
    ...
    private void setThisPage(){
        ...
        if(signed_user_user_id!=null && seller_id!=null){
            if(Integer.parseInt(seller_id) == Integer.parseInt(signed_user_user_id)) {
                signed_user=true;
                sumbit_ratings.setVisibility(View.GONE);
    ...
    public void saveReviewsRatings(int rating,String comment){
        ...
        servicesMethodsManager.setReviewsRatings(context,reviewsRatingsModel,new ServerResponseInterface() {
           ...
           /* servicesMethodsManager.setReviewsRatings(context,seller_id,"Review",comment,is_Garage,rating,productModel.getId(),new ServerResponseInterface() {
                @Override
                public void OnSuccessFromServer(Object arg0) {
                    GlobalFunctions.hideProgress();
                    Log.d(TAG, "onSuccess Response");
                    if(arg0 instanceof StatusModel){
                        StatusModel statusModel = (StatusModel) arg0;
                        if(statusModel.isStatus()){
                            Toast.makeText(context, "Reviews Submitted", Toast.LENGTH_SHORT).show();
                         //   MainActivity.replaceFragment(new ReviewsRatingsListFragment(), MessageFragment.TAG);
                            Toast.makeText(context, "Reviews Submitted", Toast.LENGTH_SHORT).show();
    ...
    public void showRating(){
        rankDialog = new Dialog(activity, R.style.FullHeightDialog);
        rankDialog.setContentView(R.layout.rank_dialog);
        rankDialog.setCancelable(true);
        ratingBar = (RatingBar)rankDialog.findViewById(R.id.dialog_ratingbar);
      /*  ratingBar.setRating(3.5);*/
