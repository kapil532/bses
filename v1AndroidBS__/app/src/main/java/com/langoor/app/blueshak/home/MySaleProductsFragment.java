...
public class MySaleProductsFragment extends Fragment {
    ...
    private MySaleProductsListAdapter adapter;
    private SalesModel salesModelData;
    private String Flag = null;
    private DatePickerDialog toDatePickerDialog;

    private TextView saleName_tv = null, saleDate_tv = null,hgl_address1=null,PhoneLabel,sale_name=null;;
    ...
    TextView no_sales;
    public static MySaleProductsFragment newInstance(SalesModel salesModel, String flag){
        MySaleProductsFragment saleFragment = new MySaleProductsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new MySaleProductsListAdapter(inflater, list,activity,salesModelData.getId());
    ...
    private void setHeader(LayoutInflater inflater){
        if(listView!=null && inflater != null){
            ...
            PhoneLabel=(TextView)headerView.findViewById(R.id.PhoneLabel);
            ...
            sale_name.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    final int DRAWABLE_BOTTOM = 3;
                     if(event.getAction() == MotionEvent.ACTION_UP) {
                        if(event.getRawX() >= (sale_name.getRight() - sale_name.getCompoundDrawables()[DRAWABLE_RIGHT].getBounds().width())) {
            ...
            options.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(Flag.equalsIgnoreCase(GlobalVariables.TYPE_MULTIPLE_ITEMS)){
                        if (popup.getMenu().findItem(R.id.move_to_multiple) != null)
                            popup.getMenu().findItem(R.id.move_to_multiple).setVisible(false);
                    }
...
// Open calender Image
                              ...
                              final AlertDialog dialog = new AlertDialog(activity);
                                ...
                                dialog.setIcon(R.drawable.ic_alert);
                                dialog.setIsCancelable(true);
                                dialog.setMessage("Are You sure you want to move this Sale to Multiple Item Sale?");
                                dialog.setPositiveButton("Yes", new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        dialog.dismiss();
    ...
    private void deleteSale(Context context, String saleID){
        ...
        servicesMethodsManager.deleteSale(context, saleID, new ServerResponseInterface() {
            ...
            public void OnSuccessFromServer(Object arg0) {
                ...
                MainActivity.replaceFragment(MySaleFragment.newInstance(GlobalVariables.TYPE_MY_SALE+""), MySaleFragment.TAG);
