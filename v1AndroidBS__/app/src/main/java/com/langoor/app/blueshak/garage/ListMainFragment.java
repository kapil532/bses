...
public class ListMainFragment extends Fragment implements
    ...
    public static ListMainFragment newInstance(CreateSalesModel sales, String type, int from){
...
//        setTabColor(mTabHost);
    ...
    public class TabsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int index) {
            switch (index) {
                case 0:
                    return CreateGarageSaleFragment.newInstance(getActivity(), null, GlobalVariables.TYPE_GARAGE,GlobalVariables.TYPE_ADD_TEMS);
                case 1:
                    return CreateItemSaleFragment.newInstance(getActivity(), null,null ,GlobalVariables.TYPE_GARAGE,GlobalVariables.TYPE_ADD_TEMS);
        ...
        servicesMethodsManager.getMySalesList(context, new ServerResponseInterface() {
            ...
            public void OnSuccessFromServer(Object arg0) {
                ...
                if(salesListModel==null)
                    salesListModel=new SalesListModel();
