...
public class Constants {
   ...
   // public static final String APPGRID_APP_KEY = "55dc7c03e4b0f6517c8d6eae";
    ...
    public static final String BROADCAST_ACTION_NOTIFICATION = "com.divrt.co.gcm.notification";
    public static final String EXTENDED_DATA_MESSAGE = "com.divrt.co.gcm.message";
