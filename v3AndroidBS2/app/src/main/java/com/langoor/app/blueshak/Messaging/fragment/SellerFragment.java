...
public class SellerFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,MessageManager.MessageListenerOne{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		adapter = new ContactsListAdapter(context, contact_list,GlobalVariables.TYPE_SELLER_TAB);
