...
//    private ItemListAdapterForList adapter;
    ...
    private  EndlessRecyclerOnScrollListener endlessRecyclerOnScrollListenerD;
    ...
    ItemListAdapterForList   adapterlist;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            if(listOrGrid)
            {
                adapterlist = new ItemListAdapterForList(context, product_list);
           ...
           /* recyclerView.setOnScrollListener(new MyScrollListener(activity) {
            ...
            else
            {
                ...
                recyclerView.setLayoutManager(gridLayoutManager);
                endlessRecyclerOnScrollListenerD=new EndlessRecyclerOnScrollListener(gridLayoutManager) {
                    @Override
                    public void onLoadMore(int current_page) {
                        if(!(current_page>last_page)){
                      /*  adapter.showLoading(true);*/
                ...
                recyclerView.addOnScrollListener(endlessRecyclerOnScrollListenerD);
            }
    ...
    public void onResume() {
        ...
        {
            endlessRecyclerOnScrollListenerD.reset(0, true);
    ...
    private void setItemListValues(HomeListModel model){
        if(model!=null){
            ...
            if(productModels!=null){
                ...
                if(listOrGrid)
                {
                    if(productModels.size()>0&&recyclerView!=null&&list!=null&&adapterlist!=null)
                    {
    ...
    public void addFilter(){
        Intent filter_intent=FilterActivity.newInstance(context,locationModel,GlobalVariables.TYPE_HOME);
